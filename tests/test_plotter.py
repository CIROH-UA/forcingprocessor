...
conf = {
    "forcing": {"nwm_file": filenamelist, "gpkg_file": [geopackage]},
    "storage": {"output_path": str(DATA_DIR), "output_file_type": ["netcdf", "csv"]},
    "run": {"verbose": False, "collect_stats": True, "nproc": 8},
}
